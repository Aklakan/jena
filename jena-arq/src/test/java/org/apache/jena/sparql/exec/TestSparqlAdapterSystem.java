...
import org.apache.jena.sparql.exec.adapter.QueryExecBuilderProvider;
import org.apache.jena.sparql.exec.adapter.SparqlAdapter;
import org.apache.jena.sparql.exec.adapter.UpdateExecBuilderProvider;
...
public class TestSparqlAdapterSystem {
    ...
    // static {  org.apache.jena.sparql.SystemARQ.DeferredExecBuilders = false; }
    ...
    /**
     * Register a custom SparqlAdapterRegistry with the dsg which sets the specified
     * query engine when using {Query|Update}ExecBuilders.
     */
    private static void setQueryEngine(DatasetGraph dsg, QueryEngineFactory qef) {
        SparqlAdapter adapterReg = new SparqlAdapter();
        SparqlAdapter.set(dsg.getContext(), adapterReg);
