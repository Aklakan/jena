...
import org.apache.jena.sparql.exec.adapter.ParseCheckUtils;
import org.apache.jena.sparql.util.Context;
import org.apache.jena.sparql.util.ContextAccumulator;
import org.apache.jena.sparql.util.Symbol;

/**
 * Base implementation for query execution builders.
 */
public abstract class QueryExecBuilderBase<X extends QueryExecBuilderBase<X>>
    implements QueryExecBuilder
{
    /** Optional dataset. Contributes to the context when not null.
     *  Sub classes are free to treat this attribute as a fixed or mutable field. */
    ...
    protected QueryExecBuilderBase() { }
