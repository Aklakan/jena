...
import org.apache.jena.sparql.engine.dispach.UpdateDispatcherRegistry;
...
//    private UpdateRequest  updateRequest      = new UpdateRequest();
    ...
    public UpdateExec build() {
        ...
        if (updateEltAcc.isParsed()) {
            ...
            uExec = UpdateDispatcherRegistry.exec(actualUpdate, dataset, initialBinding, cxt);
        } else {
            String actualString = updateEltAcc.buildString();
            uExec = UpdateDispatcherRegistry.exec(actualString, dataset, initialBinding, cxt);
        }
        return uExec;
    }
