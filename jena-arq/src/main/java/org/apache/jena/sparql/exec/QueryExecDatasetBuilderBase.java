 ...
 */
public abstract class QueryExecDatasetBuilderBase<X extends QueryExecDatasetBuilderBase<X>> implements QueryExecMod, QueryExecBuilder {
    ...
    public X query(String queryString, Syntax syntax) {
        this.query = effectiveParseCheck() ? QueryFactory.create(queryString, syntax) : null;
    ...
    public X initialBinding(Binding binding) {
