...
public class DatasetGraphWithGraphTransform extends DatasetGraphWrapper implements DatasetGraphWrapperView {
    ...
    public DatasetGraphWithGraphTransform(DatasetGraph dsg, GraphTransform graphTransform) {
        super(dsg);
        this.graphTransform = graphTransform;
    }

    public DatasetGraphWithGraphTransform(DatasetGraph dsg, Context cxt, GraphTransform graphTransform) {
        super(dsg, cxt);
        this.graphTransform = graphTransform;
    }
