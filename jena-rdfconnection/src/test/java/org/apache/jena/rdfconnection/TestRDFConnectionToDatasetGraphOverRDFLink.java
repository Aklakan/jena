...
public class TestRDFConnectionToDatasetGraphOverRDFLink extends AbstractTestRDFConnection {
    ...
    protected RDFConnection connection() {
        ...
        DatasetGraph frontendDsg = new DatasetGraphOverRDFLink(() -> RDFLink.connect(backendDsg)) {
            @Override
