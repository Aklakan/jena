...
import org.apache.jena.sparql.exec.adapter.DatasetGraphSparql;
    ...
    extends DatasetGraphSparql
{
    ...
    /* package */ DatasetGraphOverRDFLink(Creator<RDFLink> rdfLinkCreator, DsgSparqlExecutor execution, boolean supportsTransactions, boolean supportsTransactionAbort) {
        super(execution);
