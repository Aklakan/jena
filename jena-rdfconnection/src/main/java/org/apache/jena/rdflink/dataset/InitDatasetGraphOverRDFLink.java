...
import org.apache.jena.rdflink.connector.DatasetGraphConnectorARQ;
import org.apache.jena.rdflink.connector.DatasetGraphConnectorRDFLink;
...
public class InitDatasetGraphOverRDFLink implements JenaSubsystemLifecycle {
    ...
    public synchronized static void init() {
        if (!initialized) {
            ...
            SparqlAdapterRegistry.addProvider(new SparqlAdapterProviderForDatasetGraphOverRDFLink());
            ConnectorRegistry.addConnnector(new DatasetGraphConnectorARQ());
            ConnectorRegistry.addConnnector(new DatasetGraphConnectorRDFLink());
